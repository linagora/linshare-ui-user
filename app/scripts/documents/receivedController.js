...
angular.module('linshareUiUserApp')
  .controller('ReceivedController', function($scope,  $filter, ngTableParams, LinshareReceivedShareService, LinshareDocumentService){
    ...
    $scope.tableParams = new ngTableParams({
      ...
      getData: function($defer, params){
        LinshareReceivedShareService.getReceivedShares().then(function(files){
